...
//
//  def apply(tmp: StateOverrides, seq: Seq[FromToTransaction]): FreeFailFastValidationResult[StateOverrides] = seq match {
//    case h :: tail =>
...
//
//  def validateOne(overrides: StateOverrides, ftt: FromToTransaction): FreeFailFastValidationResult[StateOverrides] =
//    for {
